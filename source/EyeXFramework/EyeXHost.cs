...
namespace EyeXFramework
{
    ...
    public partial class EyeXHost : IDisposable
    {
        ...
        private readonly EngineStateAccessor<GazeTracking> _gazeTracking;
        ...
        /// </summary>
        public event EventHandler<EngineStateValue<GazeTracking>> GazeTrackingChanged
        {
            add { _gazeTracking.Changed += value; }
            remove { _gazeTracking.Changed -= value; }
        }
        ...
        /// </summary>
        public EngineStateValue<GazeTracking> GazeTracking
        {
            get { return _gazeTracking.GetCurrentValue(); }
        }
